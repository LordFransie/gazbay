 ...
 *  Formatted HTML.
 */
Drupal.theme.prototype.openlayersTestPopup = function(feature) {
  var output = '';
 ...
 */
Drupal.openlayers.addBehavior('ol_test_behavior_popup', function (data, options) {
  ...
  var popupSelect = new OpenLayers.Control.SelectFeature(layers,
    {
      onSelect: function(feature) {
        ...
        popup = new OpenLayers.Popup.FramedCloud(
          ...
          null,
          Drupal.theme('openlayersTestPopup', feature),
          null,
          true,
          function(evt) {
