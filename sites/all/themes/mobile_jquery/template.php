...
function mobile_jquery_preprocess_html(&$vars) {
	...
	if (module_exists('jquerymobile_ui')) {
	 ...
	 drupal_add_css('sites/all/libraries/jquery.mobile-1.0.1/jquery.mobile-1.0.1.min.css', $css_options);
	 ...
	 drupal_add_js('sites/all/libraries/jquery.mobile-1.0.1/jquery.mobile-1.0.1.min.js', array_merge($js_options, array('weight' => 101)));
	}
}
